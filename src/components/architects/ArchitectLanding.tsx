...
import { architectCampaign, architectFaq, architectGoals, architectWhatsAppMessage } from "@/content/architect-landing";
...
import "./architect-landing.css";

function track(event: string, placement?: string) {
  window.dispatchEvent(
    new CustomEvent("shinodalabs:landing", {
      detail: { event, page: "/landing-page-arquitetos", ...(placement ? { placement } : {}) },
    }),
  );
}
...
const services = [
  [
    ...
    "Planejamento das páginas e da narrativa do portfólio.",
  ],
  [
    Layers,
    "Design com identidade",
    "Uma experiência editorial — sem template genérico de arquitetura.",
  ],
  [
    MousePointer2,
    "Conteúdo que orienta",
    "Atuação, processo e equipe apresentados com precisão.",
  ],
  [
    Code2,
  ...
  [
    ...
    "Imagens de obra e interiores tratadas para não quebrar o LCP.",
  ],
  [
    Search,
    "SEO e mensuração",
...
export function ArchitectLanding() {
  ...
  function submit(event: FormEvent<HTMLFormElement>) {
    ...
    const message = architectWhatsAppMessage(name, business, goal);
  ...
  return (
    <div className={`law-page architect-page${stickyCta ? " law-sticky-cta-on" : ""}`}>
      <SmoothScroll />
      ...
      <main id="conteudo">
        <section className="law-hero law-wrap law-decorated">
          ...
          <div className="law-hero-copy">
            <p className="law-eyebrow">
              <span /> PRESENÇA DIGITAL PARA ARQUITETOS E ENGENHEIROS
            </p>
            <h1>
              {architectCampaign.headline}
              <em>{architectCampaign.highlight}</em>
            </h1>
            <p className="law-intro">{architectCampaign.description}</p>
            <CTA placement="hero" />
          ...
          <div className="law-showcase">
            ...
            <div className="law-browser">
              <div className="law-browser-bar">
                ...
                <span>Ambiente de ateliê</span>
                <ShieldCheck size={13} aria-hidden="true" />
              </div>
              <img
                src="/images/hero-landing-page-arquitetos.webp"
                alt="Prévia conceitual de um site para escritório de arquitetura: interior com luz natural"
                width={1536}
                height={1024}
                fetchPriority="high"
              />
        ...
        >
          <div className="law-presence-heading">
            <div>
              ...
              <h2 id="diferenca">
                A linguagem dos seus projetos
                <br />
                <span>merece um site à altura.</span>
              </h2>
            </div>
            <p>
              Instagram e portais mostram recortes. Seu site reúne linguagem, portfólio, processo e o caminho para um briefing, com performance que fotos de arquitetura normalmente destroem.
            </p>
          </div>
            ...
            {[
              {
                Icon: ShieldCheck,
                label: "APRESENTE",
                title: "Uma primeira impressão precisa",
                description:
                  "Mostre o escritório, a equipe e a linguagem projetual com a mesma disciplina de um projeto.",
              ...
              },
              {
                ...
                description:
                  "Organize tipos de projeto, disciplinas e processo para quem está escolhendo com quem projetar.",
              ...
              },
              {
                ...
                description:
                  "Facilite WhatsApp e o primeiro contato, com uma experiência confortável no celular.",
          ...
          <div className="law-presence-footer">
            <p>
              ...
              <br />
              Para quem chega pelo Instagram, pelo portfólio ou pela busca.
            </p>
            <a href="#conversa" onClick={() => track("cta_click", "presence")}>
              {architectCampaign.cta} <ArrowRight size={18} />
            </a>
          </div>
        </section>
        ...
        <section className="law-section law-surface law-decorated" aria-labelledby="entrega">
          ...
          <div className="law-wrap">
            <div className="law-section-heading">
              ...
              <p>
                Da primeira ideia ao site no ar, cada parte tem uma função: apresentar o escritório e facilitar o contato.
              </p>
            </div>
        ...
        <section className="law-fit law-wrap">
          ...
          <ul>
            {[
              ...
              "Seu site não carrega o portfólio no celular.",
              "Você quer um endereço próprio com processo claro.",
              "Você reúne arquitetura, interiores e/ou engenharia no mesmo escritório.",
            ].map((text) => (
              <li key={text}>
        ...
        >
          ...
          <div className="law-faq-list">
            ...
            {architectFaq.map(([question, answer], index) => (
        ...
        <section id="conversa" className="law-section law-wrap">
          <div className="law-contact law-decorated">
            ...
            >
              ...
              />
              <label htmlFor="architect-business">
                Escritório <span>(opcional)</span>
              </label>
              <input
                id="architect-business"
                name="business"
                autoComplete="organization"
                maxLength={150}
                placeholder="Nome do escritório"
              />
              <label htmlFor="architect-goal">
                Qual é o seu momento? <span>(opcional)</span>
              </label>
              <select id="architect-goal" name="goal" defaultValue="">
                <option value="">Selecione uma opção</option>
                {architectGoals.map((goal) => (
        ...
        <section className="law-wrap law-privacy" id="privacidade">
          <details>
            ...
            <p>
              ...
              recebido para responder à solicitação comercial. Evite informar dados de clientes de obras.
            </p>
            <p>
      ...
      <LandingFooter
        studioLine="Estúdio digital · soluções para arquitetura e engenharia"
