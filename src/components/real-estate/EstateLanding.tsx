...
import { estateCampaign, estateFaq, estateGoals, estateWhatsAppMessage } from "@/content/estate-landing";
...
import "./estate-landing.css";

function track(event: string, placement?: string) {
  window.dispatchEvent(
    new CustomEvent("shinodalabs:landing", {
      detail: { event, page: "/landing-page-imobiliarias", ...(placement ? { placement } : {}) },
    }),
  );
}
...
const services = [
  [
    ...
    "Planejamento das páginas e dos objetivos para organizar a presença digital da imobiliária.",
  ],
  [
    Layers,
    "Design com identidade",
    "Uma experiência premium — sem template de classificado.",
  ],
  [
    MousePointer2,
    "Conteúdo que orienta",
    "Atuação, equipe e região apresentados com clareza.",
  ],
  [
    Code2,
  ...
  [
    ...
    "Fotos de imóvel são pesadas; tratamos compressão de verdade.",
  ],
  [
    Search,
    "SEO e mensuração",
...
export function EstateLanding() {
  ...
  function submit(event: FormEvent<HTMLFormElement>) {
    ...
    const message = estateWhatsAppMessage(name, business, goal);
  ...
  return (
    <div className={`law-page estate-page${stickyCta ? " law-sticky-cta-on" : ""}`}>
      <SmoothScroll />
      ...
      <main id="conteudo">
        <section className="law-hero law-wrap law-decorated">
          ...
          <div className="law-hero-copy">
            <p className="law-eyebrow">
              <span /> PRESENÇA DIGITAL PARA IMOBILIÁRIAS E CORRETORES
            </p>
            <h1>
              {estateCampaign.headline}
              <em>{estateCampaign.highlight}</em>
            </h1>
            <p className="law-intro">{estateCampaign.description}</p>
            <CTA placement="hero" />
          ...
          <div className="law-showcase">
            ...
            <div className="law-browser">
              <div className="law-browser-bar">
                ...
                <span>Ambiente residencial</span>
                <ShieldCheck size={13} aria-hidden="true" />
              </div>
              <img
                src="/images/hero-landing-page-imobiliarias.webp"
                alt="Prévia conceitual de um site para imobiliária: interior residencial contemporâneo"
                width={1536}
                height={1024}
                fetchPriority="high"
              />
        ...
        <div className="law-strip">
          <div className="law-wrap">
            ...
            <i>=</i>
            <strong>UM SITE À ALTURA DA IMOBILIÁRIA.</strong>
          </div>
        </div>
        ...
        >
          <div className="law-presence-heading">
            <div>
              <p className="law-eyebrow">01 / SUA MARCA NA INTERNET</p>
              <h2 id="diferenca">
                O seu portfólio já impressiona.
                <br />
                <span>Seu site ainda pode estar à altura.</span>
              </h2>
            </div>
            <p>
              Portais e Instagram mostram anúncios. Seu site reúne a marca da imobiliária, a equipe, a região e o caminho para conversar.
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Mostre a marca, a equipe e a região de atuação em um endereço que o classificado não substitui.",
                detail: "Sua imobiliária, com identidade própria.",
              },
              {
                Icon: Layers,
                label: "ESCLAREÇA",
                title: "Atuação fácil de entender",
                description:
                  "Organize compra, venda, locação e o modo como vocês trabalham, com clareza para quem está escolhendo com quem negociar.",
              ...
              },
              {
                ...
                description:
                  "Facilite WhatsApp, conversa e escritório, com uma experiência confortável no celular.",
          ...
          <div className="law-presence-footer">
            <p>
              <strong>Um endereço próprio para a sua imobiliária.</strong>
              <br />
              Para quem chega pelos portais, pelas redes ou pela busca.
            </p>
            <a href="#conversa" onClick={() => track("cta_click", "presence")}>
              {estateCampaign.cta} <ArrowRight size={18} />
            </a>
          </div>
        </section>
        ...
        <section className="law-section law-surface law-decorated" aria-labelledby="entrega">
          ...
          <div className="law-wrap">
            <div className="law-section-heading">
              ...
              <p>
                Da primeira ideia ao site no ar, cada parte tem uma função: apresentar sua imobiliária e facilitar o contato qualificado.
              </p>
            </div>
        ...
        <section className="law-fit law-wrap">
          <div>
            ...
            <h2>
              Uma solução para
              <br />
              <span>a próxima fase da imobiliária.</span>
            </h2>
          </div>
          <ul>
            {[
              "Você está criando a primeira presença além dos portais.",
              "Seu site já não representa a imobiliária.",
              "Você quer marca própria além do Instagram.",
              "Você quer apresentar equipe, região e facilitar o contato.",
            ].map((text) => (
              <li key={text}>
        ...
        >
          <div className="law-faq-intro">
            ...
            <p>
              Do investimento à publicação, entenda como funciona a criação do site da sua imobiliária e o que alinhamos antes de começar.
            </p>
            <div className="law-faq-help">
              <MessageCircle size={28} />
              <h3>Seu projeto tem uma dúvida específica?</h3>
              <p>
                Conte o que você precisa. Vamos conversar sobre as possibilidades para a sua marca.
              </p>
          ...
          <div className="law-faq-list">
            ...
            {estateFaq.map(([question, answer], index) => (
        ...
        <section id="conversa" className="law-section law-wrap">
          <div className="law-contact law-decorated">
            ...
            <div>
              ...
              <h2>
                Sua imobiliária tem valor.
                <br />
                <span>Sua presença digital pode mostrar isso.</span>
              </h2>
              <p>
                Conte um pouco sobre seu momento. Vamos conversar sobre o site que faz sentido para a sua marca.
              </p>
            ...
            >
              ...
              />
              <label htmlFor="estate-business">
                Imobiliária / nome <span>(opcional)</span>
              </label>
              <input
                id="estate-business"
                name="business"
              ...
              />
              <label htmlFor="estate-goal">
                Qual é o seu momento? <span>(opcional)</span>
              </label>
              <select id="estate-goal" name="goal" defaultValue="">
                <option value="">Selecione uma opção</option>
                {estateGoals.map((goal) => (
        ...
        <section className="law-wrap law-privacy" id="privacidade">
          <details>
            ...
            <p>
              ...
              ela. Ao continuar, nome, imobiliária / nome e objetivo informados são
              ...
              recebido para responder à solicitação comercial. Evite informar dados de clientes ou propostas de imóveis de terceiros.
            </p>
            <p>
      ...
      <LandingFooter
        studioLine="Estúdio digital · soluções para imobiliárias e corretores"
