...
import { photographerCampaign, photographerFaq, photographerGoals, photographerWhatsAppMessage } from "@/content/photographer-landing";
...
import "./photographer-landing.css";

function track(event: string, placement?: string) {
  window.dispatchEvent(
    new CustomEvent("shinodalabs:landing", {
      detail: { event, page: "/landing-page-fotografos", ...(placement ? { placement } : {}) },
    }),
  );
}
...
const services = [
  [
    ...
    "Planejamento das páginas por tipo de trabalho e jornada de contato.",
  ],
  [
    Layers,
    "Design com identidade",
    "Uma experiência editorial, com a imagem no centro.",
  ],
  [
    MousePointer2,
    "Conteúdo que orienta",
    "Serviços, processo e formas de orçar apresentados com clareza.",
  ],
  [
    Code2,
  ...
  [
    ...
    "WebP, dimensões corretas e LCP disciplinado para o portfólio.",
  ],
  [
    Search,
    "SEO e mensuração",
    "Estrutura técnica para busca e mensuração conforme o escopo.",
  ],
] as const;
...
export function PhotographerLanding() {
  ...
  function submit(event: FormEvent<HTMLFormElement>) {
    ...
    const message = photographerWhatsAppMessage(name, business, goal);
  ...
  return (
    <div className={`law-page photo-page${stickyCta ? " law-sticky-cta-on" : ""}`}>
      <SmoothScroll />
      ...
      <main id="conteudo">
        <section className="law-hero law-wrap law-decorated">
          ...
          <div className="law-hero-copy">
            <p className="law-eyebrow">
              <span /> PRESENÇA DIGITAL PARA FOTÓGRAFOS
            </p>
            <h1>
              {photographerCampaign.headline}
              <em>{photographerCampaign.highlight}</em>
            </h1>
            <p className="law-intro">{photographerCampaign.description}</p>
            <CTA placement="hero" />
            ...
            <div className="law-hero-points">
              ...
              <span>
                <Check size={14} /> Foco no portfólio
              </span>
            </div>
          </div>
          <div className="law-showcase">
            ...
            <div className="law-browser">
              <div className="law-browser-bar">
                ...
                <span>Ambiente de estúdio</span>
                <ShieldCheck size={13} aria-hidden="true" />
              </div>
              <img
                src="/images/hero-landing-page-fotografos.webp"
                alt="Prévia conceitual de um site para fotógrafo: estúdio com luz de tungstênio"
                width={1536}
                height={1024}
                fetchPriority="high"
              />
        ...
        <div className="law-strip">
          <div className="law-wrap">
            ...
            <i>=</i>
            <strong>UM SITE À ALTURA DO SEU OLHAR.</strong>
          </div>
        </div>
        ...
        >
          <div className="law-presence-heading">
            <div>
              <p className="law-eyebrow">01 / SEU TRABALHO NA INTERNET</p>
              <h2 id="diferenca">
                Suas fotos já têm direção.
                <br />
                <span>Seu site ainda pode comprimir o olhar.</span>
              </h2>
            </div>
            <p>
              O Instagram recorta e comprime. Seu site reúne o olhar, os serviços e o contato em um endereço próprio, com imagens otimizadas de verdade.
            </p>
          </div>
            ...
            {[
              {
                Icon: ShieldCheck,
                label: "APRESENTE",
                title: "Uma primeira impressão fiel",
                description:
                  "Mostre o olhar, o estúdio e a linguagem visual com o espaço que a fotografia pede.",
                detail: "Seu trabalho, com identidade própria.",
              },
              {
                Icon: Layers,
                label: "ESCLAREÇA",
                ...
                description:
                  "Organize tipos de trabalho — casamento, comercial, retrato, produto — e o processo de orçamento.",
                detail: "Conteúdo claro. Navegação editorial.",
              },
              {
                Icon: MousePointer2,
                label: "APROXIME",
                title: "O briefing começa aqui",
                description:
                  "Facilite WhatsApp e o pedido de orçamento, com uma experiência confortável no celular.",
        ...
        <section className="law-section law-surface law-decorated" aria-labelledby="entrega">
          ...
          <div className="law-wrap">
            <div className="law-section-heading">
              ...
              <p>
                Da primeira ideia ao site no ar, cada parte tem uma função: apresentar seu trabalho e facilitar o contato.
              </p>
            </div>
        ...
        <section className="law-fit law-wrap">
          <div>
            ...
            <h2>
              Uma solução para
              <br />
              <span>a próxima fase do estúdio.</span>
            </h2>
          </div>
          <ul>
            {[
              "Você está criando a primeira presença além do Instagram.",
              "Seu site é lento ou quebra no celular.",
              "Você quer páginas por tipo de trabalho.",
              "Você tem estúdio ou marca própria e precisa de um endereço à altura.",
            ].map((text) => (
              <li key={text}>
        ...
        >
          <div className="law-faq-intro">
            ...
            <p>
              Do investimento à publicação, entenda como funciona a criação do site do estúdio e o que alinhamos antes de começar.
            </p>
            <div className="law-faq-help">
              <MessageCircle size={28} />
              <h3>Seu projeto tem uma dúvida específica?</h3>
              <p>
                Conte o que você precisa. Vamos conversar sobre as possibilidades para o seu portfólio.
              </p>
          ...
          <div className="law-faq-list">
            ...
            {photographerFaq.map(([question, answer], index) => (
        ...
        <section id="conversa" className="law-section law-wrap">
          <div className="law-contact law-decorated">
            ...
            <div>
              ...
              <p>
                Conte um pouco sobre seu momento. Vamos conversar sobre o site que faz sentido para o seu olhar.
              </p>
            ...
            >
              ...
              />
              <label htmlFor="photo-business">
                Estúdio / nome artístico <span>(opcional)</span>
              </label>
              <input
                id="photo-business"
                name="business"
              ...
              />
              <label htmlFor="photo-goal">
                Qual é o seu momento? <span>(opcional)</span>
              </label>
              <select id="photo-goal" name="goal" defaultValue="">
                <option value="">Selecione uma opção</option>
                {photographerGoals.map((goal) => (
        ...
        <section className="law-wrap law-privacy" id="privacidade">
          <details>
            ...
            <p>
              ...
              ela. Ao continuar, nome, estúdio / nome artístico e objetivo informados são
              ...
              recebido para responder à solicitação comercial. Evite enviar fotos de clientes nesta conversa. Direito de imagem do acervo é responsabilidade do fotógrafo.
            </p>
            <p>
      ...
      <LandingFooter
        studioLine="Estúdio digital · soluções para fotógrafos"
