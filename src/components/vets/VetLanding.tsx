...
import { vetCampaign, vetFaq, vetGoals, vetWhatsAppMessage } from "@/content/vet-landing";
...
import "./vet-landing.css";

function track(event: string, placement?: string) {
  window.dispatchEvent(
    new CustomEvent("shinodalabs:landing", {
      detail: { event, page: "/landing-page-veterinarias", ...(placement ? { placement } : {}) },
    }),
  );
}
...
const services = [
  [
    ...
    "Planejamento das páginas e dos objetivos para organizar a presença digital da operação.",
  ],
  [
    Layers,
    "Design com identidade",
    "Uma experiência calorosa e premium — sem visual infantil de pet shop.",
  ],
  [
    MousePointer2,
    "Conteúdo que orienta",
    "Serviços, emergência, equipe e unidades apresentados com clareza.",
  ],
  [
    Code2,
  ...
  [
    ...
    "Fotos de espaço e animais otimizadas para carregar no celular.",
  ],
  [
    Search,
    "SEO e mensuração",
...
export function VetLanding() {
  ...
  function submit(event: FormEvent<HTMLFormElement>) {
    ...
    const message = vetWhatsAppMessage(name, business, goal);
  ...
  return (
    <div className={`law-page vet-page${stickyCta ? " law-sticky-cta-on" : ""}`}>
      <SmoothScroll />
      ...
      <main id="conteudo">
        <section className="law-hero law-wrap law-decorated">
          ...
          <div className="law-hero-copy">
            <p className="law-eyebrow">
              <span /> PRESENÇA DIGITAL PARA VETERINÁRIAS E PET SHOPS
            </p>
            <h1>
              {vetCampaign.headline}
              <em>{vetCampaign.highlight}</em>
            </h1>
            <p className="law-intro">{vetCampaign.description}</p>
            <CTA placement="hero" />
          ...
          <div className="law-showcase">
            ...
            <div className="law-browser">
              <div className="law-browser-bar">
                ...
                <span>Ambiente da clínica</span>
                <ShieldCheck size={13} aria-hidden="true" />
              </div>
              <img
                src="/images/hero-landing-page-veterinarias.webp"
                alt="Prévia conceitual de um site para clínica veterinária: recepção acolhedora e chamada para contato"
                width={1536}
                height={1024}
                fetchPriority="high"
              />
        ...
        >
          <div className="law-presence-heading">
            <div>
              ...
              <h2 id="diferenca">
                O cuidado da sua equipe
                <br />
                <span>merece um site à altura.</span>
              </h2>
            </div>
            <p>
              O Instagram mostra o dia a dia. Seu site reúne serviços, emergência, equipe e localização para o tutor que precisa de clareza — especialmente no celular.
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Mostre o espaço, a equipe e os diferenciais da clínica ou do pet, com calor e credibilidade.",
                detail: "Sua operação, com identidade própria.",
              },
              {
                Icon: Layers,
                label: "ESCLAREÇA",
                ...
                description:
                  "Organize especialidades, horários, emergência e o que o tutor precisa saber antes de ir.",
              ...
              },
              {
                ...
                description:
                  "Facilite WhatsApp, emergência e mapa, com uma experiência confortável no celular.",
        ...
        <section className="law-section law-surface law-decorated" aria-labelledby="entrega">
          ...
          <div className="law-wrap">
            <div className="law-section-heading">
              ...
              <p>
                Da primeira ideia ao site no ar, cada parte tem uma função: apresentar sua clínica ou pet e facilitar o contato.
              </p>
            </div>
        ...
        <section className="law-fit law-wrap">
          <div>
            ...
            <h2>
              Uma solução para
              <br />
              <span>a próxima fase da operação.</span>
            </h2>
          </div>
          <ul>
            {[
              "Você está construindo a primeira presença digital da clínica ou pet.",
              "Seu site já não representa a estrutura e a equipe.",
              "Você quer um endereço próprio além das redes sociais.",
              "Você quer apresentar serviços, emergência e facilitar o contato.",
            ].map((text) => (
              <li key={text}>
        ...
        >
          <div className="law-faq-intro">
            ...
            <p>
              Do investimento à publicação, entenda como funciona a criação do site da sua clínica ou pet e o que alinhamos antes de começar.
            </p>
            <div className="law-faq-help">
              <MessageCircle size={28} />
              <h3>Seu projeto tem uma dúvida específica?</h3>
              <p>
                Conte o que você precisa. Vamos conversar sobre as possibilidades para a sua operação.
              </p>
          ...
          <div className="law-faq-list">
            ...
            {vetFaq.map(([question, answer], index) => (
        ...
        <section id="conversa" className="law-section law-wrap">
          <div className="law-contact law-decorated">
            ...
            <div>
              ...
              <p>
                Conte um pouco sobre seu momento. Vamos conversar sobre o site que faz sentido para a sua clínica ou pet.
              </p>
            ...
            >
              ...
              />
              <label htmlFor="vet-business">
                Clínica / pet shop <span>(opcional)</span>
              </label>
              <input
                id="vet-business"
                name="business"
                ...
                maxLength={150}
                placeholder="Nome da clínica ou pet"
              />
              <label htmlFor="vet-goal">
                Qual é o seu momento? <span>(opcional)</span>
              </label>
              <select id="vet-goal" name="goal" defaultValue="">
        ...
        <section className="law-wrap law-privacy" id="privacidade">
          <details>
            ...
            <p>
              ...
              ela. Ao continuar, nome, clínica / pet shop e objetivo informados são
              ...
              recebido para responder à solicitação comercial. Evite informar dados de tutores ou prontuários de animais.
            </p>
            <p>
      ...
      <LandingFooter
        studioLine="Estúdio digital · soluções para veterinária e pet"
