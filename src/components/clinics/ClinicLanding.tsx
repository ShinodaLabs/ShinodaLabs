...
import { clinicCampaign, clinicFaq, clinicGoals, clinicWhatsAppMessage } from "@/content/clinic-landing";
...
function track(event: string, placement?: string) {
  window.dispatchEvent(
    new CustomEvent("shinodalabs:landing", {
      detail: { event, page: "/landing-page-clinicas-medicas", ...(placement ? { placement } : {}) },
    }),
  );
}
...
const services = [
  ...
  [
    ...
    "Uma experiência sob medida que traduz a marca da clínica — sem visual hospitalar genérico.",
  ],
  [
    MousePointer2,
    "Conteúdo que orienta",
    "Especialidades, equipe e unidades apresentadas com clareza.",
  ],
  [
    Code2,
...
export function ClinicLanding() {
  ...
  function submit(event: FormEvent<HTMLFormElement>) {
    ...
    const message = clinicWhatsAppMessage(name, business, goal);
  ...
  return (
    <div className={`law-page clinic-page${stickyCta ? " law-sticky-cta-on" : ""}`}>
      <SmoothScroll />
      ...
      <main id="conteudo">
        <section className="law-hero law-wrap law-decorated">
          ...
          <div className="law-hero-copy">
            <p className="law-eyebrow">
              <span /> PRESENÇA DIGITAL PARA CLÍNICAS MÉDICAS
            </p>
            <h1>
              {clinicCampaign.headline}
              <em>{clinicCampaign.highlight}</em>
            </h1>
            <p className="law-intro">{clinicCampaign.description}</p>
            <CTA placement="hero" />
          ...
          <div className="law-showcase">
            ...
            <div className="law-browser">
              <div className="law-browser-bar">
                ...
                <span>Ambiente de clínica</span>
                <ShieldCheck size={13} aria-hidden="true" />
              </div>
              <img
                src="/images/hero-landing-page-clinicas-medicas.webp"
                alt="Prévia conceitual de um site para clínica médica: recepção contemporânea e chamada para contato"
                width={1536}
                height={1024}
                fetchPriority="high"
              />
        ...
        >
          <div className="law-presence-heading">
            <div>
              ...
              <h2 id="diferenca">
                A confiança do seu consultório
                <br />
                <span>merece um site à altura.</span>
              </h2>
            </div>
            <p>
              Uma indicação ou um anúncio pode despertar o interesse. Seu site ajuda a dar o próximo passo: conhecer a clínica, entender as especialidades e encontrar o melhor caminho para marcar consulta.
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Mostre a marca, as instalações e o corpo clínico em um site que transmita o cuidado da prática.",
              ...
              },
              {
                ...
                description:
                  "Organize exames, convênios e informações relevantes para que o visitante conheça a clínica antes de ligar.",
              ...
              },
              {
                ...
                description:
                  "Facilite o acesso ao WhatsApp, à central e à localização, com uma experiência confortável no celular.",
          ...
          <div className="law-presence-footer">
            ...
            <a href="#conversa" onClick={() => track("cta_click", "presence")}>
              {clinicCampaign.cta} <ArrowRight size={18} />
            </a>
          </div>
        </section>
        ...
        <section className="law-section law-surface law-decorated" aria-labelledby="entrega">
          ...
          <div className="law-wrap">
            <div className="law-section-heading">
              ...
              <p>
                Da primeira ideia ao site no ar, cada parte tem uma função: apresentar sua clínica e facilitar a decisão de entrar em contato.
              </p>
            </div>
        ...
        <section className="law-fit law-wrap">
          ...
          <ul>
            {[
              ...
              "Seu site já não representa o corpo clínico nem as instalações.",
              "Você quer um endereço próprio além das redes sociais.",
              "Você quer apresentar especialidades, unidades e facilitar o contato.",
            ].map((text) => (
              <li key={text}>
        ...
        >
          ...
          <div className="law-faq-list">
            ...
            {clinicFaq.map(([question, answer], index) => (
        ...
        <section id="conversa" className="law-section law-wrap">
          <div className="law-contact law-decorated">
            ...
            <div>
              ...
              <p>
                Conte um pouco sobre seu momento. Vamos conversar sobre o site que faz sentido para a sua clínica.
              </p>
            ...
            >
              ...
              />
              <label htmlFor="clinic-goal">
                Qual é o seu momento? <span>(opcional)</span>
              </label>
              <select id="clinic-goal" name="goal" defaultValue="">
                <option value="">Selecione uma opção</option>
                {clinicGoals.map((goal) => (
        ...
        <section className="law-wrap law-privacy" id="privacidade">
          <details>
            ...
            <p>
              ...
              recebido para responder à solicitação comercial. Evite informar dados de pacientes. Saúde é dado sensível.
            </p>
            <p>
      ...
      <LandingFooter
        studioLine="Estúdio digital · soluções para clínicas médicas"
